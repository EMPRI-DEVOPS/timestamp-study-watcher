...
TIMESTAMPS: Dict[str, Sequence[TS]] = {
    ...
    "pullcommit": (
        TS("commit", "BODY/DIV/DIV/MAIN/DIV/DIV/DIV/DIV/DIFF-FILE-FILTER/DIV/DIV/DIV/RELATIVE-TIME",
           previous=[
               ("BODY/DIV/DIV/MAIN/DIV/DIV/DIV/DIV/DIV/DIV/DIV/RELATIVE-TIME", date(2022, 1, 17)),
           ],
        ),
        TS("commitdropdown", "BODY/DIV/DIV/MAIN/DIV/DIV/DIV/DIV/DIFF-FILE-FILTER/DIV/DIV/DIV/DIV/DETAILS/DETAILS-MENU/DIV/DIV/A/DIV/SPAN/RELATIVE-TIME", True,
           previous=[
